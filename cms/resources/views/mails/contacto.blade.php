...
<head>
    ...
    <title>Contraseña FAC</title>
</head>
<body>
   
    <p>Sr usuario a continuación se encuentra contraseña temporal para activación y acceso al Módulo de Certificaciones en Línea FAC</p>
    <ul>
    ...
    <p>
    Jefatura de Relaciones Laborales <br>
    Fuerza Aérea Colombiana <br>
    Ministerio de Defensa<br>
    Cra. 54 # 26-25 CAN <br>
    Conmutador:  3159800 <br>
    </p>
    <div style="display:block;">
        <img src="{{ $message->embed(public_path() . '/img/logo1.png') }}" alt="">
        <img src="{{ $message->embed(public_path() . '/img/logo2.png') }}" alt="">        
    <br>
    <hr>
    <i>
    <small>
