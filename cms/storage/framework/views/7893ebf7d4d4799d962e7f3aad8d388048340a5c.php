    ...
    <table>
      <tr>
        <td>                 
          ...
          y código militar <?php echo e($dataPagos['devengado'][0]->codigo_militar); ?> está en <?php echo e(session('tnomina')); ?> del mes de <?php echo e($mesLetra); ?> del <?php echo e($ano); ?> y le figura 
          ...
          <p style="font-size: 12px;">Se expide en Bogotá D.C. al (los) <?php echo e(strftime("%d de %B del %Y")); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\cms\resources\views/pdf/pago.blade.php ENDPATH**/ ?>