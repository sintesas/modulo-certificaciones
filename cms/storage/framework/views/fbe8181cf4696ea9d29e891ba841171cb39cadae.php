    ...
    <table>
      <tr>
        <td>                 
          ...
          <p class="texto">
            Que el(la) Señor(a)(ita) (<?php echo e($dataCC[0]->grado_actual); ?>) <?php echo e($dataCC[0]->apellidos_nombres); ?> identificado con CC No. <?php echo e($dataCC[0]->identificacion); ?>. ingresó a FUERZA AÉREA COLOMBIANA
          ...
          <div style="margin-left: 7%;"> 
            <table class="table1 center">
              ...
              <?php $__currentLoopData = $dataCC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
              
              <?php if($key == 5): ?>
              <div class="salto"></div>
              <?php endif; ?>
                <tr>
                  <td class="td22"><?php echo e($cc->grado_cargo); ?></td> 
                  <td class="td2"><?php echo e($cc->cargo); ?></td>
                  <td class="td20"><?php echo e($cc->dependencia_cargo); ?></td>
                  <td class="td2"><?php echo e(date("d-m-Y", strtotime($cc->fecha_inicio))); ?></td>
                  <?php if($cc->fecha_termino == ''): ?>
                    <td></td>
                  <?php else: ?>
                  <td class="td2"> <?php echo e(date("d-m-Y", strtotime($cc->fecha_termino))); ?></td>
                  <?php endif; ?>
                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\cms\resources\views/pdf/cargos.blade.php ENDPATH**/ ?>