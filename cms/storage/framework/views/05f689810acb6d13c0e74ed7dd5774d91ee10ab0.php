      ...
      <div class="col-lg-12">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(url('/admin/Laboral/create')); ?>"  accept-charset="UTF-8" enctype="multipart/form-data">

            <?php else: ?>

            <form method="POST" action="<?php echo e(url('/admin/Laboral/update/'.$id)); ?>"  accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="tipo" class="form-control" id="exampleFormControlSelect1" >
                  ...
                  <option value="<?php echo e($Laboral['tipo']); ?>"><?php echo e($Laboral['tipo']); ?></option>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cms\resources\views/laboral/create.blade.php ENDPATH**/ ?>