									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
                                            ...
                                            <form method="POST" action="<?php echo e(route('login')); ?>" id="formulario-login">
												...
												<a href="<?php echo e(url('forgot-password')); ?>"  style="color:blue; margin-left:70px; text-decoration: underline;" >Recuperar Contraseña</a>
												<br>
												<br>
												<span class="badge bg-info text-dark" style="padding:10px; margin-left:20px;">Servicio para personal Activo y Retirado FAC</span>
												<br>
												<br>
												<button class="btn btn-primary btn-block" type="submit" style="margin-top: -10px;">Ingresar</button>
												<br>
												<div class="alert alert-info" role="alert">
													Sr usuario debe validar su correo institucional o personal. Por favor dar <a href="<?php echo e(url('validate')); ?>" class="alert-link">validar aquí</a>
												</div>
												<div class="alert alert-info" role="alert">
...
<?php endif; ?>
<?php /**PATH C:\Apache24\htdocs\resources\views/auth/login.blade.php ENDPATH**/ ?>